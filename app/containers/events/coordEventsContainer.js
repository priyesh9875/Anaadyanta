...
class CoordinatingEventsContainer extends Component {
  ...
  renderView() {
    ...
    if (Object.keys(coordinatingEvents).length == 0) {
      return (
        <View style={{ flex: 1, padding: 10,  justifyContent: "center", alignItems: "center", backgroundColor: 'white' }} >
          <Text style={{ fontSize: 30, textAlign: "center" }} >Oops, you are not coordinating any events.</Text>
          <Text style={{ fontSize: 20, textAlign: "center" }} >Ask admins to assign events</Text>
        </View>
      );
    }
    return (
